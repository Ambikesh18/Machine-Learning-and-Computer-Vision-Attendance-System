...
# known_faces_dir = r'C:\Users\91777\Desktop\ML_COURSE\ml'
known_faces_dir = r"C:\Users\91777\Desktop\ML_COURSE\ml"
# Load known faces
known_faces = []
known_names = []
...
def capture_image():
    ...
    while True:
        ...
        if not ret:
            ...
            break
        cv2.imshow('Press Q to quit or Space to capture', frame)
...
def mark_attendance(student_name, file=r'C:\Users\91777\Desktop\ML_COURSE\attendance.xlsx'):
    now = datetime.now()
